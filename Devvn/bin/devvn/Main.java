...
static char[] letters;
	...
	public static void main(String[] args){
	    ...
	    if(numberofletters == 0){letters = new char[21]; numberofletters = 21; dm = true; System.out.println("Wilkommen zur\u00FCck, Meister. DevMode aktiviert. Anzahl Buchstaben auf 21 gesetzt.");}
...
if(dm)	System.out.println("dx" + namelist);
	    ...
	    processing.verarbeitung(field, inputs, numberofletters, length, namelist, dm);
